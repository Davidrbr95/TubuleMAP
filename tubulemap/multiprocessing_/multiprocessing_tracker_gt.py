...
if __name__ == '__main__':
    kp_folder = '/media/cfxuser/SSD1/Nephron_Tracking/Che_mouse_kidney_data/Ground_Truth_Nephrons/Cortex/PCT_david'
    volume = "/media/cfxuser/SSD1/Nephron_Tracking/Che_mouse_kidney_data/oldeci.zarr"
    ...
    for idx, value in enumerate(names):
        ...
        default_params_copy['save_dir'] = 'Human_in_loop_gt_david_all20PCT_adaptdiamTrue'
